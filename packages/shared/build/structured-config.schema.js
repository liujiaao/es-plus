...
const formTypeEnum = VALID_FORM_TYPES;
const crudActionEnum = VALID_CRUD_ACTIONS;
const FieldConfigSchema = z.object({
    ...
    formatter: z.string().optional().describe('Extension point: a JS arrow-function source string for read-only cell formatting, e.g. "(row) => row.amount.toFixed(2)". Use this to express display logic the schema can\'t otherwise capture.'),
    render: z.string().optional().describe("Extension point: a render-function source string for a fully custom cell/form control. Emit this (rather than dropping the requirement) when business logic exceeds the declarative schema."),
...
//# sourceMappingURL=structured-config.schema.js.map