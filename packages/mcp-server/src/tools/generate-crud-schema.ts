...
export function registerGenerateCrudSchema(server: McpServer) {
  server.tool(
    ...
    "Generate CrudPageSchema JSON + minimal wrapper SFC from a natural language description. Recommended over full SFC mode — produces simpler, more maintainable output using <es-crud-page> component.",
    {
      description: z
        .string()
        .describe(
