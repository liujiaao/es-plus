...
const PKG_DIR: Record<Target, string> = {
  vue3: "vue3",
  vue2: "vue2",
  antdv: "adapter-antdv",
};
...
const CRUD_PAGE_TYPES_REL: Record<Target, string> = {
...
const RENDERER_TYPES_REL: Record<Target, string> = {
...
export function crudPageTypesPath(target: Target): string {
...
export function rendererTypesPath(target: Target): string {
...
export function bundledPath(file: string): string {
