import { crudPageTypesPath, bundledPath, readFirst, } from "./source-locator.js";
...
function loadCrudPageTypes(target) {
    return (readFirst([crudPageTypesPath(target), bundledPath("crud-page-types.d.ts")]) ??
