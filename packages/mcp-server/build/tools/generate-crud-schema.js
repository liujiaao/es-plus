...
export function registerGenerateCrudSchema(server) {
    server.tool("generate_crud_schema", "Generate CrudPageSchema JSON + minimal wrapper SFC from a natural language description. Recommended over full SFC mode — produces simpler, more maintainable output using <es-crud-page> component. Supports vue3 (default) / vue2 targets.", {
        description: z
            .string()
