...
export function registerGenerateCrudPage(server) {
    server.tool("generate_crud_page", "Generate a CRUD page from a natural language description. Supports two modes: 'schema' (default, recommended) outputs CrudPageSchema JSON + wrapper SFC; 'sfc' outputs a full Vue 3 SFC.", {
        description: z
            .string()
        ...
        mode: z
            .enum(["schema", "sfc"])
            .default("schema")
            .describe("Output mode: 'schema' (default) for CrudPageSchema JSON + minimal wrapper using <es-crud-page>; 'sfc' for complete Vue 3 SFC with EsTable + EsForm"),
