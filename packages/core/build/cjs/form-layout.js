...
exports.getRowColsAlgorithm = getRowColsAlgorithm;
exports.shouldShowFoldButton = shouldShowFoldButton;
exports.getBtnColSpan = getBtnColSpan;
exports.applyFoldFlags = applyFoldFlags;
/**
 ...
 * @returns 行列布局结果
 */
function getRowColsAlgorithm(formItemList) {
    let pre = 0;
 ...
 */
function shouldShowFoldButton(layoutResult, minFoldRows) {
 ...
 */
function getBtnColSpan(layoutResult, formItemList, folded, btnColSpan) {
 ...
 */
function applyFoldFlags(formItemList, layoutResult, folded, minFoldRows) {
    if (!folded) {
