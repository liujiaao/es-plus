...
exports.applySelectionChange = applySelectionChange;
exports.restoreSelectionForPage = restoreSelectionForPage;
exports.clearAllSelection = clearAllSelection;
/**
 * 创建空的选择状态
 */
 ...
 */
function applySelectionChange(state, val, currentPage, rowkey, cachePageSelection = true) {
 ...
 * @param rowkey 行唯一键
 */
function restoreSelectionForPage(state, dataList, tableRef, rowkey) {
 ...
 * 清空所有页的选择（含跨页缓存）
 */
function clearAllSelection(state, tableRef) {
