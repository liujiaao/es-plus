 ...
 */
export declare function resolveKeepPage(explicit: boolean | undefined, refetchKeepPage: unknown): boolean;
/** 分页边界回退判定的输入 */
export interface BoundaryRollbackInput {
    /** 本次是否为保留页模式 */
    keepPage: boolean;
    /** 本次拉取后当前页的数据条数 */
    rowCount: number;
 ...
 */
export declare function computeBoundaryRollback(input: BoundaryRollbackInput): BoundaryRollbackResult;
