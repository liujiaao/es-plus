 ...
 */
export declare const PUBLIC_CONTRACT_TYPES: readonly ["ModelData", "RenderFn", "AnyVNode", "EsButtonType", "EsButtonSize", "EsTableSize", "ApiParams", "FormType", "FormItemOption", "BtnConfig", "LayoutFormProps", "ListenToCallBack", "TableColumn", "ConfigTableOut", "TableOptions", "PaginationConfig", "DialogOptions", "EsFormInstance", "EsTableInstance", "EsPlusOptions", "VxeEditRender", "VxeEditConfig", "VxeExportConfig", "VxeToolbarConfig", "VxeColumnConfig", "VxeKeyboardConfig", "VxeMouseConfig", "VxeClipboardConfig", "VxeValidConfig", "VxeFooterMethod", "VxeTreeConfig", "VxeProxyConfig", "VxeExpandConfig", "VxeSeqConfig", "TableEngineExposed"];
export type PublicContractTypeName = (typeof PUBLIC_CONTRACT_TYPES)[number];
