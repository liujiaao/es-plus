 ...
 * @param rowkey 行唯一键
 */
export declare function restoreSelectionForPage(state: SelectionState, dataList: ModelData[], tableRef: TableRefLike, rowkey?: string): void;
/**
 * 清空所有页的选择（含跨页缓存）
 */
export declare function clearAllSelection(state: SelectionState, tableRef: TableRefLike): void;
