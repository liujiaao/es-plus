<template>
  <div class="example-selection-table">
    <div class="toolbar">
      <a-button type="primary" :disabled="!selectedCount" @click="handleBatchDelete">
        批量删除 ({{ selectedCount }})
      </a-button>
      <a-button @click="handleClearAll">清空选择</a-button>
    </div>
    <es-table
      ref="tableRef"
...
const handleBatchDelete = async () => {
  try {
    await Modal.confirm({ title: '提示', content: `确定删除选中的 ${selectedCount.value} 项吗？`, okType: 'warning' })
