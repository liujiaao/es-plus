<template>
  <div class="example-dialog-crud">
    <a-button type="primary" @click="openCRUD">增删改查弹窗</a-button>
  </div>
</template>
...
const handleDelete = (row) => {
  Modal.confirm({ title: '删除确认', content: `确定要删除「${row.name}」吗？`, okType: 'warning' })
    .then(() => {
...
const openCRUD = () => {
  crudDialog({
    ...
    configBtn: [
      {
        name: '新增项目', type: 'primary', icon: 'PlusOutlined',
        click: () => {
