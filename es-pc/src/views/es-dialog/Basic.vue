<template>
  <div class="example-dialog-basic">
    <a-button type="primary" @click="openDialog">打开基础弹窗</a-button>
    <a-button @click="openWithContent">带内容弹窗</a-button>
  </div>
</template>
...
const openWithContent = () => {
  dialog({
    title: '信息提示',
    width: '450px',
    render: () => h('div', { style: 'padding: 10px' }, [
      h('p', '这是一条重要的信息提示。'),
