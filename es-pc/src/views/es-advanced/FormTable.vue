...
const queryItems = [
  ...
  { prop: 'priceRange', label: '价格区间', formtype: 'Select', span: 6, dataOptions: priceOptions, attrs: { allowClear: true } },
  { prop: 'rating', label: '评分', formtype: 'Select', span: 6, dataOptions: ratingOptions, attrs: { allowClear: true } },
  { prop: 'sortBy', label: '排序', formtype: 'Select', span: 6, dataOptions: sortOptions, attrs: { allowClear: true } }
]
