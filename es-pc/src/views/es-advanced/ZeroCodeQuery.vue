<template>
  <div class="example-zero-code-query">
    <div class="comparison-header">
      <Tag type="danger" size="large" effect="dark">传统写法 50+ 行</Tag>
      <span class="arrow">→</span>
      <Tag type="success" size="large" effect="dark">es-plus 配置 10 行</Tag>
    </div>
    <es-table
      ref="tableRef"
      :columns="columns"
...
// 仅声明表单项，无需绑定事件
const queryItems = [
  { prop: 'keyword', label: '关键词', formtype: 'Input', span: 8, attrs: { placeholder: '搜索商品', allowClear: true } },
  { prop: 'category', label: '分类', formtype: 'Select', span: 8, dataOptions: categoryOptions, attrs: { allowClear: true } }
]
